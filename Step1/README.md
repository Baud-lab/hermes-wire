...
It performs read-level pre-processing and microbiome profiling from shallow-shotgun metagenomic sequencing data. This automated and reproducible Nextflow pipeline executes:
