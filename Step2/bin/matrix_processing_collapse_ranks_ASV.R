...
allowed <- c("Phylum", "Class", "Order", "Family", "Genus", "Species")
...
for (rank in ranks){
  for (subset_id in subset_ids) {
    ...
    if (method=="16S"){
      collapsed_matrix[-c(which(rownames(collapsed_matrix)=="s__"),
                          which(rownames(collapsed_matrix)=="g__"),
                          which(rownames(collapsed_matrix)=="f__"),
                          which(rownames(collapsed_matrix)=="c__"),
                          which(rownames(collapsed_matrix)=="o__"),
                          which(rownames(collapsed_matrix)=="p__")),]
    }
